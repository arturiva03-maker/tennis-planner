    ...
    <div className="ballotForm" style={themeStyle}>
      ...
      <div className="sheet-wide">
        ...
        <div className="prose">
          ...
          <p>
            (2) Für eine Folgesaison ist eine erneute Anmeldung erforderlich; nach einmaliger Anmeldung genügt hierfür das Ausfüllen des Anmeldefragebogens. Ein
            bereits erteiltes SEPA-Mandat muss nicht erneut unterschrieben werden.
          </p>
          <p>
            (3) Das Recht zur außerordentlichen Kündigung aus wichtigem Grund (§ 314 BGB) und nach § 627 BGB bleibt unberührt. Ein wichtiger Grund liegt insbesondere
            bei länger andauernder Krankheit, Schwangerschaft oder Verletzung vor (nicht abschließend).
          </p>
          <p>
            (4) Bei grobem Fehlverhalten oder wiederholtem, vom Kunden zu vertretendem Zahlungsverzug bzw. wiederholten Rücklastschriften sind wir nach vorheriger
            Abmahnung zur außerordentlichen Kündigung berechtigt. Bereits gezahlte, aber nicht erbrachte Beiträge werden in diesem Fall anteilig erstattet.
          </p>
        </div>

                    ...
                    for (const spieler of spielerMitEmail) {
                      ...
                      const resp = await fetch("/api/send-newsletter", {
                        ...
                        body: JSON.stringify({
                          ...
                          html: `<!DOCTYPE html><html><head><meta charset="utf-8"></head><body style="margin:0;padding:0;background:#eef3fb;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#eef3fb;padding:32px 0;"><tr><td align="center"><table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.06);"><tr><td style="padding:32px 40px;color:#1a1a1a;font-size:15px;line-height:1.7;">${personalizedBody.replace(/\n/g, "<br>")}</td></tr><tr><td style="background-color:#eef3fb;padding:24px 40px;border-top:1px solid #d7e3f1;"><p style="margin:0 0 4px;color:#333;font-size:14px;font-weight:600;">Sportliche Grüße</p><p style="margin:0;color:#1668c7;font-size:15px;font-weight:700;">Tennisschule A bis Z</p><p style="margin:12px 0 0;color:#999;font-size:12px;">${tAnlage === "Britz" ? "Standort Britz · TC Blau-Weiß Britz" : "Standort Wedding · BSC Rehberge"}</p><img src="${window.location.origin}/logo.png" alt="Tennisschule A bis Z" style="width:140px;height:auto;border-radius:8px;margin-top:16px;" /></td></tr></table></td></tr></table></body></html>`,
                          fromName: "Tennisschule A bis Z",
